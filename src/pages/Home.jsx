  ...
  return (
    <Container>
      <div className="grid [grid-template-areas:'bottle_orangeSlice''cone_sugar'] sm:[grid-template-areas:'bottle_orangeSlice_cone_sugar'] auto-cols-fr auto-rows-fr">
        <div className="[grid-area:bottle] bg-[url('/images/mobile/image-gallery-milkbottles.jpg')] bg-cover bg-no-repeat bg-center min-h-[20rem] sm:min-h-[30rem]" />
        <div className="[grid-area:orangeSlice] bg-[url('/images/mobile/image-gallery-orange.jpg')] bg-cover bg-no-repeat bg-center min-h-[20rem] sm:min-h-[30rem]" />
        <div className="[grid-area:cone] bg-[url('/images/mobile/image-gallery-cone.jpg')] bg-cover bg-no-repeat bg-center min-h-[20rem] sm:min-h-[30rem]" />
        <div className="[grid-area:sugar] bg-[url('/images/mobile/image-gallery-sugar-cubes.jpg')] bg-cover bg-no-repeat bg-center min-h-[20rem] sm:min-h-[30rem]" />
      </div>
    </Container>
  );
};
    ...
    <Container>
      <div className="bg-primary-moderate-cyan grid place-items-center py-16">
        ...
        <ul className="flex gap-16">
          <li>
            <a
              className="text-testimonialsMobileTitle text-primary-dark-desaturated-cyan"
              href="#"
            >
              About
            </a>
